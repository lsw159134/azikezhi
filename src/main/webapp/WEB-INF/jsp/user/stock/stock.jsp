...
<body>
	<header class="navbar-wrapper" >
		<div class="navbar navbar-fixed-top" style="background-color: #222222;height: 30px;">
			<div class="container-fluid cl" >
				<div style="display: inline-block;background: #222222;width: 200px;margin-left: -15px;height: 30px;position: absolute;text-align: center;line-height: 50px;font-size: 16px;font-weight: bold;">
	...
	<aside class="Hui-aside" style="background: white;font: 微软雅黑;font-size: 11px;">
		...
		<div class="menu_dropdown bk_2">
			...
			<dl id="menu_2">
				...
				<dt style="border: none;">
					<ul>
						<li>
							<a href="queryByInquiryUserid" data-title="询价记录" style="font-weight: normal;">
								&emsp;&emsp;询价记录（采购记录）
							</a>
						</li>
						<li>
							<a href="quoteAllByUser" data-title="报价记录" style="font-weight: normal;">
								&emsp;&emsp;报价记录
							</a>
						</li>
						<li style="background: #D0DFEF;">
							<a href="stockAll" data-title="库存管理" style="font-weight: normal;">
								<img style="position: absolute;margin-top: 8px;" src="<%=basePath%>logo/yuan.png">&emsp;&emsp;库存管理（销售订单）
							</a>
						</li>
					</ul>
				</dt>
				...
				<ul id="min_title_list" >
					<li >
						<nav class="zznav" style="margin-top: 9px;margin-left: 13px;">
							<a href="index">首页</a>
							<a href="stockAll" class="selected">库存管理</a>
						</nav>
					</li>
				</ul>
			</div>
