					...
					<c:if test="${status.count <= 24 }">
						<p  title="${enList.encapsulation }" style="display: inline-block;width: 170px;line-height: 30px;">
							<a class="endiva" data-encapsulation="${enList.encapsulation }" 
							   href="shaixuanse4?primary_name=${primary_name }&&product_second=${product_second }&&encapsulation=${enList.encapsulation}" 
				...
				<c:forEach items="${manufacturerList }" var="maList" varStatus="status">
					<c:if test="${status.count <= 24 }">
						<p title="${maList.manufacturer }" style="display: inline-block;width: 200px;line-height: 30px;">
							<a class="madiva" href="shaixuanse5?primary_name=${primary_name }&&product_second=${product_second }&&manufacturer=${maList.manufacturer}" style="color: blue;">${maList.manufacturer } (${maList.product_primary })</a>
						</p>
					</c:if>
