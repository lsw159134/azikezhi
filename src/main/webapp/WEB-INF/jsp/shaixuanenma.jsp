...
<html lang="lang=zh-cmn-Hans">
	...
	<body >
		<div class="shaixuan" style="background: #F5F5F5;padding:20px 0px 20px 150px;">
			<c:if test="${ manufacturer != null && encapsulation != null}">
				<p style="margin-left: -130px">
					...
					<span style="font-weight: bold;"><a href="shaixuanenma?keyword=${keyword }&&manufacturer=${manufacturer }&&encapsulation=${encapsulation }"> - (封装)${encapsulation } </a></span>
				</p>
			...
			<c:if test="${enSize > 0 }">
				...
				<c:forEach items="${encapsulationList }" var="enList" varStatus="status">
					...
					<a href="shaixuanma?keyword=${keyword }&&product_second=${product_second }&&manufacturer=${manufacturer}&&ennum=${ennum }&&manum=${manum }">
			...
			<c:if test="${maSize > 0 }">
				...
				<c:forEach items="${manufacturerList }" var="maList" varStatus="status">
					...
					<a href="shaixuanen?keyword=${keyword }&&product_second=${product_second }&&encapsulation=${encapsulation}&&ennum=${ennum }&&manum=${manum }">
						<img style="position: absolute;margin-top: 2px;" src="logo/clearshaixuan.png">
					</a>
				</c:forEach>
			</c:if>
