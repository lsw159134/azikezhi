	...
	<div class="row">
		<div class="col-xs-6" style="width: 600px">
			<form id="form" method="post"
				action="<%=basePath%>1019/zai/xin/jian/updateByPrimaryKeySelective"
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="批号"
								id="lotnumber" name="lotnumber" value="${product.lotnumber}"
								required />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<!-- <div class="col-md-6" >
						<div class="">
							<div class="input-group-addon" style="border-right: 1px solid #C3C3C3;">分类</div>
							<div id="product_primary"></div>
						</div>
					</div> -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group" style="float: left;">
							...
							<label style="position: absolute; margin-top: 50px"
								class="control-label" for="lastName"> 图片1:
								<div
									style="border: 1px #99D3F5 solid; width: 200px; height: 35px; text-align: center;">
									<span class="fileerrorTip1"></span>
								</div>
								<div
									style="border: 1px #99D3F5 solid; width: 200px; height: 35px; text-align: center; position: absolute; margin-top: -35px;">
									<span class="showFileName1"></span>
								</div>
							</label> <a style="margin-left: 200px; margin-top: 67px" class="file1">选择文件
								<input id="img1" type="file" name="img1">
							</a>
							<c:if test="${imgCount >= 1}">
								<input type="button" style="margin-top: 20px" id="button1"
									value="查看原图" onclick="imgoneBasic()" />
							</c:if>
							<input type="button" style="margin-top: 20px" id="button1"
								value="预览" onclick="imgone()" />
						</div>
				...
				<div style="margin-top: 30px" class="row">
					<div class="col-md-12">
						<div class="form-group" style="float: left;">
							<label style="position: absolute; margin-top: 50px"
								class="control-label" for="lastName"> 图片2:
								<div
									style="border: 1px #99D3F5 solid; width: 200px; height: 35px; text-align: center;">
							...
							</label> <a style="margin-left: 200px; margin-top: 67px" class="file2">选择文件
								<input id="img2" type="file" name="img2">
							</a>
							<c:if test="${imgCount >1 && imgCount <= 3}">
								<input type="button" id="button1" value="查看原图"
									onclick="imgtwoBasic()" />
							</c:if>
				...
				<div style="margin-top: 50px" class="row">
					<div class="col-md-12">
						<div class="form-group" style="float: left;">
							<label style="position: absolute; margin-top: 50px"
								class="control-label" for="lastName"> 图片3:
								<div
									style="border: 1px #99D3F5 solid; width: 200px; height: 35px; text-align: center;">
							...
							</label> <a style="margin-left: 200px; margin-top: 67px" class="file3">选择文件
								<input id="img3" type="file" name="img3">
							</a>
							<c:if test="${ imgCount == 3}">
								<input type="button" id="button1" value="查看原图"
									onclick="imgthreeBasic()" />
							</c:if>
				...
				<br /> <br />
				<button
					style="position: fixed; left: 300px; top: 100px; z-index: 999;"
