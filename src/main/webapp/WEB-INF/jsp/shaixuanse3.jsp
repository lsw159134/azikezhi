		...
		<div class="shaixuan" style="background: #F5F5F5;padding:20px 0px 20px 150px;">
			<c:if test="${product_second != null || manufacturer != null || encapsulation != null || primary_name != null}">
				<p style="margin-left: -130px">
					 ...
					 <c:if test="${manufacturer != null }"><span style="font-weight: bold;"><a href="manufacturer?manufacturer=${manufacturer }">${manufacturer }</a></span></c:if>
				</p>
					...
					<c:if test="${status.count <= 24 }">
						<p  title="${enList.encapsulation }" style="display: inline-block;width: 170px;line-height: 30px;">
							<a class="endiva" data-encapsulation="${enList.encapsulation }" 
							   href="shaixuanse6?primary_name=${primary_name }&&encapsulation=${enList.encapsulation}&&manufacturer=${manufacturer }" 
			...
			<c:forEach items="${manufacturerList }" var="maList" varStatus="status">
				...
				<a href="shaixuanse?primary_name=${primary_name }&&ennum=${ennum }&&manum=${manum }">
