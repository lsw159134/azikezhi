				...
				<div class="main-wrap">
					<div class="bd data-list">
						...
						<div class="pagn-bottom">
							...
							<c:if test="${count>1 }">
								<c:if test="${page>1}">
									<a href="ziliao?name=${name }&page=${page-1 }&rows=10" class="page-prev">上一页</a>
									<a href="ziliao?name=${name }&page=${page-1 }&rows=10" class="page-num">${page-1 }</a>
								</c:if>
								...
								<c:if test="${count!=page && page<3}">
									<a href="ziliao?name=${name }&page=${page+1 }&rows=10" class="page-num">${page+1 }</a>
									<a href='ziliao?name=${name }&page=${page+1 }&rows=10' class="page-next">下一页</a>
								</c:if>
							</c:if>
						</div>
					</div>
					<c:if test="${empty material }">
						...
						<div class="bd data-list" style="margin-top: 8px;">
							<div class="data-list-hd">
								<span class="data-type" style="font-size: 18px;width: 80px;"><b>用户提问</b></span> 
								<span class="data-name" style="font-size: 18px;">&nbsp;</span> 
								<span class="download-times">&nbsp;</span> 
								<span class="upload-user">&nbsp;</span> 
								<span class="upload-time">&nbsp;</span>
							</div>
							<div class="data-list-hd" style="margin-top: 8px;">
								<span class="data-type" style="width: 30px;">格式</span> 
								<span class="data-name">名称</span> 
