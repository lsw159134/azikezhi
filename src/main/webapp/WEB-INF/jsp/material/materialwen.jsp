						...
						<table cellpadding="0" cellspacing="0" style="text-align: center;border: 1px #E5E5E5 solid;border-collapse:collapse;">
							...
							<tr>
								<td colspan="2" style="padding-top: 20px">
									<span style="font-size: 13px;">昨日成交订单:</span>
...
<div class="shaixuan" style="background: #F0F8FF;padding:20px 0px 45px 250px;">
	<div style="float: left;">
		...
		<%-- <input type="text" name="q" class="bdcs-search-form-input" value="${name }" id="material" placeholder="搜索资料" autocomplete="off" style="height: 25px; line-height: 28px;width: 230px;float: left;margin-left: 120px;margin-top: 10px;">
		<input type="submit" style="border-color: #a6a6a6;height: 25px;width: 50px;background-color: #f5f5f5;color: #000000;font-family: Arial,SimSun,sans-serif;font-size: 14px;margin-top: 10px;margin-left: 10px;" id="queryName" value="搜索"> --%>
	</div>
</div>
<br>
...
<div id="page" class="data-channel" style="margin-top: -20px;width: 1200px;">
	<div id="header">
		<div class="gg gg-header">
		    <!-- <div id="download-list-top-big" class="openx_ad_zone mt10" ad-id="179" ad-width="728" ad-height="90" style="width: 728px; display: inline-block;"></div>
			<div id="download-list-top-small" class="openx_ad_zone mt10" ad-id="369" ad-width="260" ad-height="90" style="width: 260px; display: inline-block;"></div> -->
		</div>
	</div>
	<div id="content">
		<div class="column">
			<div class="col-main" style="width: 1050px;padding-left: 0px;">
				<div class="main-wrap">
					<div class="bd data-list">
						<div class="order-panel" style="height: 45px;">
							<h1 class="page-title" style="margin-top: 15px;color: #00BFFF">${material.material_name }</h1>
							<div class="order yahei">
									时间：<fmt:formatDate value="${material.material_time}" pattern="yyyy-MM-dd"/>
							</div>
						</div>
