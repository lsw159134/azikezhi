...
<header>
		...
		<a href="index">
			...
			<div id="right" style="margin-top: -130px;" >
				<div id="search" >
						<input id="keyword" type="text" value="${name }" name="keyword"
							placeholder="搜索资料">
							<input id="submit"
							type="submit" value="资料搜索" style="height: 49px;background: #FFA500;">
					<div style="margin-left: 875px;position: absolute;width: 200px;" >
		...
		<%
	        ...
	        %>
				<div id="regLogin" style="margin-top: -40px; text-align:right;width:600px;">
					<span id="userName" style="width: 180px;"> <img src="<%=basePath%>img/userIcon.png" />
				...
				<div class="main-wrap">
					<div class="bd data-list">
						<div class="data-list-hd">
							...
							<span class="download-times">下载量</span> 
							<span class="upload-user">&nbsp;</span> 
							<span class="upload-time">上传时间</span>
						</div>
						<ul class="data-list-bd" id="J_DataList" style="height: 660px;">
						...
						<div class="pagn-bottom">
							...
							<c:if test="${count>1 }">
								<c:if test="${page>1}">
									<a href="ziliaolistw?page=${page-1 }&rows=10" class="page-prev">上一页</a>
									<a href="ziliaolistw?page=${page-1 }&rows=10" class="page-num">${page-1 }</a>
								</c:if>
								<strong class="page-cur">${page }</strong>
								<c:if test="${count!=page && page<3}">
									<a href="ziliaolistw?page=${page+1 }&rows=10" class="page-num">${page+1 }</a>
									<a href='ziliaolistw?page=${page+1 }&rows=10' class="page-next">下一页</a>
								</c:if>
							</c:if>
						</div>
					</div>
