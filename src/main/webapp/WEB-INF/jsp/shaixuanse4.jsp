		...
		<div class="shaixuan" style="background: #F5F5F5;padding:20px 0px 20px 150px;">
			<c:if test="${product_second != null || manufacturer != null || encapsulation != null || primary_name != null}">
				<p style="margin-left: -130px">
					 ...
					 <c:if test="${product_second != null }"><span style="font-weight: bold;"><a href="shaixuanse1?primary_name=${primary_name }&&product_second=${product_second }"> - ${product_second } </a></span></c:if>
					 <c:if test="${encapsulation != null }"><span style="font-weight: bold;"><a href="shaixuanse4?primary_name=${primary_name }&&product_second=${product_second }&&encapsulation=${encapsulation }"> - (封装)${encapsulation } </a></span></c:if>
				</p>
			...
			<p title="${product_second }" style="min-width: 160px;line-height: 30px;border: 1px #FFA500 solid;text-align: center;display: inline-block;">
				${product_second } &nbsp;&nbsp;
			</p>
			<a href="shaixuanse2?primary_name=${primary_name }&&encapsulation=${encapsulation }">
			...
			<c:forEach items="${encapsulationList }" var="enList" varStatus="status">
				...
				<a href="shaixuanse1?primary_name=${primary_name }&&product_second=${product_second}">
					<img style="position: absolute;margin-top: 2px;" src="logo/clearshaixuan.png">
				</a>
			</c:forEach>
				...
				<c:forEach items="${manufacturerList }" var="maList" varStatus="status">
					<c:if test="${status.count <= 24 }">
						<p title="${maList.manufacturer }" style="display: inline-block;width: 200px;line-height: 30px;">
							<a class="madiva" href="shaixuanse7?primary_name=${primary_name }&&product_second=${product_second }&&manufacturer=${maList.manufacturer}&&encapsulation=${encapsulation }&&manum=${maList.product_primary }&&ennum=${ennum}" style="color: blue;">${maList.manufacturer } (${maList.product_primary })</a>
						</p>
					</c:if>
