				...
				<div class="line2_2_2">
					<div class="index-tab">
						<div class="index-slide-nav">
							...
							<a href="Logindynamic" class="active" style="margin-left: 40px;" >动态登录</a>
					...
					<form action="Loginverification" method="post" class="login form">
						...
						<div class="group">
							...
							<div class="group-ipt">
								<input type="text" name="telephone" id="telephone" class="ipt" placeholder="手机号码" required>
							</div>
							...
							<div class="group-ipt yanzhen">
								<input type="text" placeholder="短信验证码" id="yanzhen" name="yanzhen" class="ipt" style="width:191px;float: left;" onfocus="clearErro();" required>
	  	   	     	   	    	<input type="button" id="hsbtn" value="获取验证码" onclick="time(hsbtn)" style="width: 97px;background:#CBE9CF;margin-left: 10px;" />
							</div>
						</div>
						<br>
						<div class="button">
