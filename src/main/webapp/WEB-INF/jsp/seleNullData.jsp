...
<body class="container-fluid" style="margin-top: 20px;">
	<div class="row">
		<div class="col-xs-6" style="width:600px">
			<form id="form" method="post" action="<%=basePath %>1019/zai/xin/jian/updateByPrimaryKeySelective" enctype="multipart/form-data" style="width: 500px;margin-left: 200px;margin-top: 50px;">
				...
				<div class="row">
					...
					<div class="col-md-6" style="position: absolute;margin-left: 600px;">
						<div class="input-group">
							<div class="input-group-addon">标记是否打电话</div>
								<select style="font-weight: bold;font-size: 20px;color: red;" class="form-control" id="complaintprice" name="complaintprice">
									<c:if test="${product.complaintprice == 0}">
										<option selected="selected" value="0" style="color: green;font-weight: bold;">√</option>
									...
									<c:if test="${product.complaintprice == 1}">
										...
										<option selected="selected" value="1" style="color: red;font-weight: bold;">×</option>
									</c:if>
								</select>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="封装"
								id="encapsulation" name="encapsulation" value="${product.encapsulation }"  required />
						</div>
					</div>
					<div class="col-md-6">
						<div class="input-group">
					...
					<div class="col-md-6" >
						<div class="input-group">
							...
							<input type="text" class="form-control"
								placeholder="价格(元)" id="price" name="price" value="${product.price}" required />
...
<script type="text/javascript">
	$(function(){
		...
		$.post("queryBrandProductAll",
			function(data){
				for(var o in data) {
					if('${product.manufacturer}'==data[o].brand_id){
						$("#manufacturer").append('<option value="'+data[o].brand_id+'" selected="selected" >'+data[o].brand_name+'</option>');
					}else{
