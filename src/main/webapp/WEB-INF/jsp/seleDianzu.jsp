...
<script>
function first(){
	window.location.href='seleDianzu?page=${1}&&rows=${pageSize }&manufacturer=${sessionScope.manufacturer}&product=${sessionScope.product}&&isgoodsinstock=123';
}
function end(){
	var supplier = $("#supplier").val();
	var search = $("#search").val();
	window.location.href='seleDianzu?page=${count == 0 ? 1:count }&&rows=${pageSize }&manufacturer=${sessionScope.manufacturer}&product=${sessionScope.product}&&isgoodsinstock=123';
}
function previous(){
	var page=${page == 1};
	var supplier = $("#supplier").val();
...
function next(){
	...
	if(page){
		...
		window.location.href='seleDianzu?page=${page+1}&&rows=${pageSize }&manufacturer=${sessionScope.manufacturer}&product=${sessionScope.product}&&isgoodsinstock=123';
	}
}
//搜索
function searchProduct() {
	...
	var url = 'seleDianzu?manufacturer=' + manufacturer+'&productQuality='+product;
	window.location = url;
};
