					...
					<tbody >
						<c:forEach items="${inquiry}" var="inquiry" varStatus="status">
							<tr style="<c:if test='${status.count%2==0 }'>background:#F3F3F3</c:if>">
								<td style="height: 40px;width: 80px;"><p style="padding-left: 10px;width: 140px;overflow: hidden;clear:both;text-overflow:ellipsis;white-space: nowrap;text-align: left;" title="${inquiry.user.username}">${inquiry.user.username}</p></td>
								<td style="height: 40px;width: 140px;"><p style="padding-left: 10px;width: 140px;overflow: hidden;clear:both;text-overflow:ellipsis;white-space: nowrap;text-align: left;" title="${inquiry.inquiry_product}">${inquiry.inquiry_product}</p></td>
								<td style="height: 40px;width: 140px;" title="">
									<c:if test="${inquiry.supplier.suppliername == null}">
										<p style="width: 140px;overflow: hidden;clear:both;text-overflow:ellipsis;white-space: nowrap;text-align: left" title="${inquiry.inquiry_supplier}">${inquiry.inquiry_supplier}</p>
									</c:if>
									<p style="width: 140px;overflow: hidden;clear:both;text-overflow:ellipsis;white-space: nowrap;" title="${inquiry.supplier.suppliername}">${inquiry.supplier.suppliername}</p>
								</td>
								<td style="height: 40px;text-align: center;" title="">
									<c:if test="${inquiry.supplier.telphone1 == null}">
										${inquiry.inquiry_telphone}
									</c:if>
									${inquiry.supplier.telphone1}
								</td>
								<td style="height: 40px;text-align: center;">${inquiry.inquiry_brand}</td>
								<td style="height: 40px;text-align: center;">${inquiry.inquiry_lotnumber}</td>
								<td style="height: 40px;text-align: center;">${inquiry.inquiry_package}</td>
								<td style="height: 40px;text-align: center;">${inquiry.inquiry_number}</td>
								<td style="height: 40px;text-align: center;">￥${inquiry.inquiry_price}元</td>
								<td style="height: 40px;text-align: center;">${inquiry.inquiry_quality}</td>
								<td style="height: 40px;text-align: center;width: 140px;">
								...
								<td style="height: 40px;text-align: center;">
									...
									<c:if test="${inquiry.inquiry_status==2}">
