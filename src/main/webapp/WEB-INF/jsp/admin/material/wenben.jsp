...
<div style="margin-left: 60px;">
	标题：<input type="text" name="biaoti" id="biaoti" style="width: 300px;height: 27px;"><br><br>
	标签：<input type="text" name="biaoqian" id="biaoqian" style="width: 700px;height: 27px;">
	<button onclick="getContent()" style="float:right;margin-right: 340px;">提交文章</button>
</div>
