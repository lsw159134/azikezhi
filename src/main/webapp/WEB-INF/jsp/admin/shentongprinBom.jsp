...
<div id="myPrintArea" style="margin-top: 40px;margin-left: 30px;background:url(<%=contextPath%>/img/shentong.png);width: 800px;height: 450px;">
	...
	<div style="margin-left: 60px;margin-top: 70px;float: left;">
		<div style="margin-left: 10px;margin-top: 6px;">
			<span style="margin-left: 60px;" id="name">${bom.bom_name }</span>
		...
		<div style="margin-left: 60px;margin-top: 8px;">
			<span style="" id="telphone">${bom.bom_phone }</span>
		</div>
	</div>
</div>
<div id="aa" style="margin-top: 40px;margin-left: 30px;background:url(<%=contextPath%>/img/shentong.png);width: 800px;height: 450px;">
	...
	<div style="margin-left: 60px;margin-top: 80px;float: left;">
		<div style="margin-left: 10px;margin-top: 6px;">
			<span style="margin-left: 60px;" id="name1">${bom.bom_name }</span><span id="up1" style="color: red;">修改</span><span id="qu1" style="color: red;">确定</span>
		...
		<div style="margin-left: 40px;margin-top: 8px;">
			<span style="" id="telphone1">${bom.bom_phone }</span><span id="up6" style="color: red;">修改</span><span id="qu6" style="color: red;">确定</span>
		</div>
	</div>
</div>
...
$("#up3").on("click", function(){
	...
	$("#province1").html("<input text='type' style='width:100px; ' id='nameu' value='"+u1+"'>");
...
$("#up4").on("click", function(){
	var u1=$("#city1").html();
	$("#city1").html("<input text='type' style='width:100px; ' id='nameu' value='"+u1+"'>");
...
$(document).ready(function(){  
	$("input#biuuu_button").click(function(){  
		...
		if (confirm("是否打印")==true){ 
			...
			$.post("kuaididayinjilv?printrecord_eid=${bom.bom_id}&printrecord_kuaidi=申通&printrecord_expressorder=${bom.bom_identifier}",
		        function(data){
