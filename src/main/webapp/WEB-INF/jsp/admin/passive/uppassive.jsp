...
<body class="container-fluid" style="margin-top: 20px;">
	<div class="row">
		<div class="col-sm-12" style="width: 100%">
			<form id="form" method="post" action="<%=basePath %>1019/zai/xin/jian/updatepassiveS" enctype="multipart/form-data" style="width: 500px;margin-left: 200px;margin-top: 50px;">
				<div class="row">
					<div class="col-md-12" >
						<div class="input-group">
							<div class="input-group-addon">公司名称</div>
							<input type="hidden" name="passivecomponentsuid" value="${passive.passivecomponentsuid }">
							<input type="text" class="form-control" placeholder="公司名称"
								id="name" name="name" value="${passive.name }" required />
						</div>
					</div>
				</div>
				<br/>
					...
					<div class="col-md-6" >
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="请输入固话"
								id="phone1" name="phone1" value="${passive.phone1 }" />
						</div>
					</div>
					<div class="col-md-6" >
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="请输入固话"
								id="phone2" name="phone2" value="${passive.phone2 }" />
						</div>
					</div>
				</div>
				<br/>
					...
					<div class="col-md-12" >
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="请输入地址"
								id="address" name="address" value="${passive.address }"/>
						</div>
					</div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-12" >
						<div class="input-group">
							...
							<input type="text" name="illustration" class="goodinstock input-text" value="${passive.illustration }" placeholder="请输入地址">
						</div>
					</div>
				</div>
				<br />
				<div class="row">
					<div class="col-md-6" >
						<div class="input-group">
							...
							<input type="text" name="cellphone" value="${passive.cellphone }" class="goodinstock input-text" placeholder="请输入手机号码">
						</div>
					</div>
					<div class="col-md-6" >
						<div class="input-group">
							<div class="input-group-addon">排序</div>
							<input type="text" class="form-control" value="${passive.down }" placeholder="排序"
				...
				<div class="row">
					<div class="col-md-6" >
						<div class="input-group">
							...
							<input type="text" name="qq1" value="${passive.qq1 }" class="goodinstock input-text" placeholder="请输入QQ号码">
						</div>
					</div>
					<div class="col-md-6" >
						<div class="input-group">
							<div class="input-group-addon">QQ2</div>
							<input type="text" name="qq2" value="${passive.qq2 }" class="goodinstock input-text" placeholder="请输入QQ号码">
						</div>
					</div>
				</div>
				<br />
...
<script type="text/javascript">
	$(function(){
	   	var primaryid='${passive.passive_cid }';
		$.post("classificationAll",
			function(data){
				for(var o in data) {
					if('${passive.passive_cid}'!=data[o].classification_id){
						$("#product_primary").append('<option value="'+data[o].classification_id+'">'+data[o].classification_name+'</option>');
					}else{
						$("#product_primary").append('<option value="'+data[o].classification_id+'" selected="selected" >'+data[o].classification_name+'</option>');
					}
				}
			}
	   	)
	   	$.post("subcategoryList?subcategory_classification="+primaryid,
			function(data){
				for(var o in data) {
					if('${passive.passive_sid}'!=data[o].subcategory_id){
						$("#product_second").append('<option value="'+data[o].subcategory_id+'">'+data[o].subcategory_name+'</option>');
					}else{
						$("#product_second").append('<option value="'+data[o].subcategory_id+'"selected="selected">'+data[o].subcategory_name+'</option>');
					}
