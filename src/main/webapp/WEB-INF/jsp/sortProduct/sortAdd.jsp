...
<html lang="lang=zh-cmn-Hans">
	...
	<body>
		<div style="text-align: center;width: 1200px;height: 100%">
			<form action="sort_update?productuuid=${productuuid}" method="post">
				<table  cellpadding="3" cellspacing="3" border="1px" style="width: 680px;text-align: center;margin-left: 22%">
					...
					<tr>
						...
						<td>
							<input type="text" name="sort_miaoshu" value="${sortAdd.sort_miaoshu}"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="sort_lianjie" value="${sortAdd.sort_lianjie}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">外设</td>
						<td>
							<input type="text" name="sort_waishe" value="${sortAdd.sort_waishe}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">IO</td>
						<td>
							<input type="text" name="sort_io" value="${sortAdd.sort_io}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">RAM</td>
						<td>
							<input type="text" name="sort_ram" value="${sortAdd.sort_ram}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">数据转换</td>
						<td>
							<input type="text" name="sort_shujuzhuanhuan" value="${sortAdd.sort_shujuzhuanhuan}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">电压</td>
						<td>
							<input type="text" name="sort_dianya" value="${sortAdd.sort_dianya}" />
						</td>
					</tr>
					<tr>
						<td style="width: 80px;background-color: #87CEEB;font-weight: bold;	">温度</td>
						<td>
							<input type="text" name="sort_wendu" value="${sortAdd.sort_wendu}" />
						</td>
					</tr>
				</table>
