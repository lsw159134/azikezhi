		...
		<div class="shaixuan" style="background: #F5F5F5;padding:20px 0px 20px 150px;">
			<c:if test="${product_second != null || manufacturer != null || encapsulation != null || primary_name != null}">
				<p style="margin-left: -130px">
					 ...
					 <c:if test="${manufacturer != null }"><span style="font-weight: bold;"><a href="shaixuanse5?primary_name=${primary_name }&&product_second=${product_second }&&manufacturer=${manufacturer }"> - (品牌)${manufacturer } </a></span></c:if>
					 <c:if test="${encapsulation != null }"><span style="font-weight: bold;"><a href="shaixuanse7?primary_name=${primary_name }&&product_second=${product_second }&&manufacturer=${manufacturer }&&encapsulation=${encapsulation }"> - (封装)${encapsulation } </a></span></c:if>
				</p>
			...
			<a href="shaixuanse6?primary_name=${primary_name }&&encapsulation=${encapsulation }&&manufacturer=${manufacturer }">
			...
			<c:forEach items="${encapsulationList }" var="enList" varStatus="status">
				...
				<a href="shaixuanse5?primary_name=${primary_name }&&product_second=${product_second }&&manufacturer=${manufacturer }">
					<img style="position: absolute;margin-top: 2px;" src="logo/clearshaixuan.png">
				</a>
			</c:forEach>
			...
			<c:forEach items="${manufacturerList }" var="maList" varStatus="status">
				...
				<a href="shaixuanse4?primary_name=${primary_name }&&product_second=${product_second }&&encapsulation=${encapsulation }">
					<img style="position: absolute;margin-top: 2px;" src="logo/clearshaixuan.png">
				</a>
			</c:forEach>
		</div>
