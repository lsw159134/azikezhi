...
<link rel="stylesheet" type="text/css" href="<%=contextPath %>css/updateProduct.css">
...
<body class="container-fluid" style="margin-top: 20px;">
	<div class="row">
		<div class="col-xs-6" style="width:600px">
			<form id="form" method="post" action="<%=basePath %>1019/zai/xin/jian/updateQuality" enctype="multipart/form-data" style="width: 500px;margin-left: 200px;margin-top: 50px;">
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="生产厂商"
								id="manufacturer" name="manufacturer" value="${product.manufacturer }" required />
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control"
								id="p_data" value="${product.p_data }" name="p_data"/>
						</div>
					</div>
				</div>
				<br />
