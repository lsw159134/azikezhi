...
var tooltip=function(B){"use strict";
	var f="length",Eb="addEventListener",ab,oc,Nb=function(){},
	Ib=function(a,c,b){if(a[Eb])a[Eb](c,b,false);else a.attachEvent&&a.attachEvent("on"+c,b)},
	a={},
	V=function(a){
	...
	ac=function(d){
		...
		if(a)for(var b=0,e=a[f];b<e;b++)a[b].nodeType==1&&c.push(a[b]);return c
	},
	Y={a:0,b:0},
	g=null,
	gc=function(a){
		if(!a)a=window.event;Y.a=a.clientX;Y.b=a.clientY
	},
	ec=function(a){
		if(window.getComputedStyle)var b=window.getComputedStyle(a,null);
		else if(a.currentStyle)b=a.currentStyle;else b=a[d];return b
	},
	u="offsetLeft",
	v="offsetTop",
	ob="clientWidth",
	...
	var Qb=function(a){
		...
		x,
		mb,
		C=function(c,a,b){return setTimeout(c,a?a.showDelay:b)},
		bb=function(a){clearTimeout(a);return null};
	Jb.prototype={
		d:{b:Nb,c:function(a){return-Math.cos(a*Math.PI)/2+.5}},
		e:function(i,d,h,f){
			for(var a=[],g=h-d,c=Math.ceil((l.duration||9)/15),e,b=1;b<=c;b++){
				e=d+f.c(b/c)*g;a.push(e)
			}
			a.d=0;
			return a
		},
		f:function(){this.b==null&&this.g()},
		g:function(){this.h();var a=this;this.b=setInterval(function(){a.h()},15)},
		h:function(){
			var a=this.a[f];
			if(a){
				for(var c=0;c<a;c++)this.i(this.a[c]);
				while(a--){var b=this.a[a];if(b.c.d==b.c[f]){b.d();this.a.splice(a,1)}}
			}else{clearInterval(this.b);this.b=null}
		},
		i:function(a){
			if(a.c.d<a.c[f]){
				var c=a.b,b=a.c[a.c.d];
				if(a.b==I){
					a.a.op=b;
					if(tb){c="filter";b="alpha(opacity="+w(b*100)+")"}
				}else b+="px";a.a[d][c]=b;a.c.d++
			}
		},
