...
public interface ResistanceZoneService {
	...
	List<ResistanceResult> seleResistance(Map<String, Object> map);
	...
	void insertResistance(Product product);
	...
	List<ResistanceResult> queryBaozhuang(String encapsulation, String zhuzhi, String jingquedu, String manufacturer);
